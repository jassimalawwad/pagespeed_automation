...
url_list = pd.read_excel('/mnt/c/Users/jassim/Desktop/python/lighthouse_automation/urls.xlsx')
...
def CSV(df):
    df.to_csv('/mnt/c/Users/jassim/Desktop/python/lighthouse_automation/results.csv', mode='a', header=False)
